package test.flour 
{
	...
	public class FlourTest extends SSenSprite 
	{
		...
		public function FlourTest()
		{
			...
			loader.load(new URLRequest("FlourFontLibrary.swf"));
		...
		private function fontLoaded(event : Event) : void
		{
			...
			var fontLibrary : Class = info.applicationDomain.getDefinition("ssen.flour.text.FlourFontLibrary") as Class;
			Font.registerFont(fontLibrary["NanumGothicRegular"]);
