package ssen.flour.scroll 
{
	 ...
	 * @author SSen
	 */
	public class FlourScrollBarThinV extends ScrollBarBase 
	{
		...
		public function FlourScrollBarThinV(height : Number,
											...
											maxValue : Number = 0)
		{
			...
			var f : int;
			var directionMode : String = DirectionMode.VERTICAL;
			...
			_track = new FlourScrollTrackThineV(height - _buttonGroupUpPosition.height - _buttonGroupDownPosition.height);
			
			addChildren(_buttonGroupUpPosition, _buttonGroupDownPosition, _track);
			setting(_track, _buttonGroupUpPosition, _buttonGroupDownPosition, directionMode, 10, height);
